...
# symlink power terminal
ln -s -f $HOME/.dotfiles/zsh/p10k.zsh $HOME/.p10k.zsh

# Test if folder "~/.config/nvim/lua" exists
ln -s -f $HOME/.dotfiles/nvim-astro $HOME/.config/nvim/lua/user
