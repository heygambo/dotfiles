...
local config = {
  ...
  options = {
    ...
    g = {
      ...
      copilot_no_tap_map = true,
      copilot_node_command = "/Users/gambo/.nvm/versions/node/v16.15.1/bin/node"
    },
  },
  ...
  mappings = {
    ...
    n = {
      ...
      ["<leader>i"] = { "<cmd>e ~/.config/nvim/lua/user/init.lua<cr>", desc = "Edit Astro User Config" },
      ...
      -- vnoremap <leader>d "_d
        ["<leader>y"] = { "\"-y", desc = "Magic Paste" },
        ["<leader>d"] = { "\"_d", desc = "Magic Delete" },

        -- This map is to split and then move the focus
        ["<leader>v"] = { "<C-w>v<C-w>l", desc = "Vertical Spit" },
    ...
    x = {
        ["<leader>p"] = { "_dp", desc = "Magic Paste" }
    },
    v = {
        ["<leader>p"] = { "\"+y", desc = "Magic Paste" },
        ["<leader>d"] = { "\"_d", desc = "Magic Delete" }
    }
  },
